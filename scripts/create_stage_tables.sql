...
-- Eseguire questo script nel database scuola_calendario

-- Tabella per registrare i giorni di stage con presenze e ore
...
-- Tabella per i documenti associati agli stage
